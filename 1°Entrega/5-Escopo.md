## Funcionalidades incluídas na primeira versão do sistema
...
## Itens que não farão parte do projeto neste momento
...
## Restrições relevantes de prazo, tecnologia, acesso ou integração
